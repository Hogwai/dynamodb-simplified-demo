...
public class PostSearchRequest {
    ...
    public static class Builder {
        ...
        public Builder subreddit(String v) { this.subreddit = v; return this; }
        public Builder author(String v) { this.author = v; return this; }
        public Builder keyword(String v) { this.keyword = v; return this; }
        public Builder sinceUtc(Long v) { this.sinceUtc = v; return this; }
        public Builder untilUtc(Long v) { this.untilUtc = v; return this; }
        public Builder titleContains(String v) { this.titleContains = v; return this; }
        public Builder minKeywords(Integer v) { this.minKeywords = v; return this; }
